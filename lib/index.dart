// Export pages
export '/pages/home/report/report_widget.dart' show ReportWidget;
...
export '/pages/gestion_categorias/crear_categoria_page/crear_categoria_page_widget.dart'
    show CrearCategoriaPageWidget;
export '/pages/gestion_categorias/editar_categoria_page/editar_categoria_page_widget.dart'
    show EditarCategoriaPageWidget;
export '/pages/gestion_transaccion/transaccion_page/transaccion_page_widget.dart'
    show TransaccionPageWidget;
export '/pages/gestion_transaccion/crear_transaccion_page/crear_transaccion_page_widget.dart'
    show CrearTransaccionPageWidget;
export '/pages/gestion_estadisticas/estadisticas/estadisticas_widget.dart'

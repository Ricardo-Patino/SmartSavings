...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    smartSavingsProyectoAuthUserSubject.add(
      SmartSavingsProyectoAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SmartSavingsProyectoAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SmartSavingsProyectoAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SmartSavingsProyectoAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    smartSavingsProyectoAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SmartSavingsProyectoAuthUser? currentUser;

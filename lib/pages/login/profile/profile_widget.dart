...
class _ProfileWidgetState extends State<ProfileWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {
        _model.nicknameInputTextController?.text = _model.user!.name;
      });
      safeSetState(() {
        _model.emailInputTextController?.text = _model.user!.email;
      });
      _model.userPasswordLogged = await actions.decryptData(
        _model.user!.password,
      );
      safeSetState(() {
        _model.currentPasswordInputTextController?.text =
            _model.userPasswordLogged!;
      });
    });
    ...
    _model.currentPasswordInputTextController ??= TextEditingController();
    _model.currentPasswordInputFocusNode ??= FocusNode();
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                            .currentPasswordInputTextController,
                                        focusNode: _model
                                            .currentPasswordInputFocusNode,
                                        autofocus: false,
                                        textInputAction: TextInputAction.next,
                                        obscureText: !_model
                                            .currentPasswordInputVisibility,
                                        decoration: InputDecoration(
                                          isDense: true,
                                          labelStyle: FlutterFlowTheme.of(
                                                  context)
                                          ...
                                          suffixIcon: InkWell(
                                            ...
                                            child: Icon(
                                              _model.currentPasswordInputVisibility
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      if ((_model.nicknameInputTextController
                                                      .text !=
                                                  '') &&
                                          (_model.currentPasswordInputTextController
                                                      .text !=
                                                  '')) {
                                        _model.encrytedPassword =
                                            await actions.encryptData(
                                          _model
                                              .currentPasswordInputTextController
                                              .text,
                                        );
                                        if (_model.encrytedPassword ==
                                            profileUsersRecord?.password) {
                                          if (_model.newPasswordInputTextController
                                            ...
                                            if (_model
                                              ...
                                              ScaffoldMessenger.of(context)
                                                ...
                                                SnackBar(
                                                  content: Text(
                                                    'Passwords dont match. Plrease try again.',
                                                    style: TextStyle(
                                                      color:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'Nickname and Password should not be empty.',
                                              style: TextStyle(
                                                color:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                ...
                                var confirmDialogResponse =
                                    await showDialog<bool>(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title: Text(
                                                  'Are you dure you want to delete your account?'),
                                              content: Text(

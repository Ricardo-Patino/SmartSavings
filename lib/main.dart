...
class _MyAppState extends State<MyApp> {
  ...
  List<String> getRouteStack() =>
      _router.routerDelegate.currentConfiguration.matches
          .map((e) => getRoute(e))
          .toList();
  late Stream<SmartSavingsProyectoAuthUser> userStream;
  ...
  void initState() {
    ...
    userStream = smartSavingsProyectoAuthUserStream()
      ..listen((user) {
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'ResumenMensual': ResumenMensualWidget(),
      'ResumeCategoria': ResumeCategoriaWidget(),
      'ResumenHistorico': ResumenHistoricoWidget(),
    };
